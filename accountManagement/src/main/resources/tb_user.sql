...
';
   COMMENT ON COLUMN "C##SCOTT"."TB_USER"."ACCOUNT" IS '账户
';
   COMMENT ON COLUMN "C##SCOTT"."TB_USER"."PASSWORD" IS '密码
';
   COMMENT ON COLUMN "C##SCOTT"."TB_USER"."EMAIL" IS '邮箱
';
